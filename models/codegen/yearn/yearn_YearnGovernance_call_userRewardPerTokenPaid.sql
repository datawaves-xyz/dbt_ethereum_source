{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_userrewardpertokenpaid_calldecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_userRewardPerTokenPaid_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x8b876347"
    and selector_hash = abs(hash("0x8b876347")) % 10
