{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_withdrawn_eventdecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_Withdrawn_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.9.jar";'
        }
    )
}}
