{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_rewardpaid_eventdecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_RewardPaid_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
