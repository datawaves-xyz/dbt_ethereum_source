{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_breaker_calldecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_breaker_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.1.jar";'
        }
    )
}}
