{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function yearn_yearngovernance_ysupplyindex_calldecodeudf as "io.iftech.sparkudf.hive.Yearn_YearnGovernance_ySupplyIndex_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.2.jar";'
        }
    )
}}
