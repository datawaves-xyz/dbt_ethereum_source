{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_openseaensresolver_openseaversion_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_OpenSeaENSResolver_openSeaVersion_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.3.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x4060b25e"
    and selector_hash = abs(hash("0x4060b25e")) % 10
