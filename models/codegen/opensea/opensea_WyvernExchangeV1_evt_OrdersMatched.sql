{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev1_ordersmatched_eventdecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV1_OrdersMatched_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.8.jar";'
        }
    )
}}
