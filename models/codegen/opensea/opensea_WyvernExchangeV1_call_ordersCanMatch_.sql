{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev1_orderscanmatch__calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV1_ordersCanMatch__CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x72593b4c"
    and selector_hash = abs(hash("0x72593b4c")) % 10
