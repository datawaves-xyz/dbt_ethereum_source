{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev2_calculatematchprice__calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV2_calculateMatchPrice__CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.3.jar";'
        }
    )
}}
