{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_openseaensresolver_setbaseuri_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_OpenSeaENSResolver_setBaseURI_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
