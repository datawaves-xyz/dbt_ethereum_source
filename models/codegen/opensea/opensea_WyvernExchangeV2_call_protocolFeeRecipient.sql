{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev2_protocolfeerecipient_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV2_protocolFeeRecipient_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
