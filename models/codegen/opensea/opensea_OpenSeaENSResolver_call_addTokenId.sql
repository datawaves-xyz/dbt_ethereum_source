{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function opensea_openseaensresolver_addtokenid_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_OpenSeaENSResolver_addTokenId_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.1.jar";'
        }
    )
}}
