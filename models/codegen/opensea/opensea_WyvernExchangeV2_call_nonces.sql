{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev2_nonces_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV2_nonces_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0x7ecebe00"
    and selector_hash = abs(hash("0x7ecebe00")) % 10
