{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function opensea_wyvernexchangev1_calculatefinalprice_calldecodeudf as "io.iftech.sparkudf.hive.Opensea_WyvernExchangeV1_calculateFinalPrice_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
