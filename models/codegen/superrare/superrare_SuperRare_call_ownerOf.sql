{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function superrare_superrare_ownerof_calldecodeudf as "io.iftech.sparkudf.hive.Superrare_SuperRare_ownerOf_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
