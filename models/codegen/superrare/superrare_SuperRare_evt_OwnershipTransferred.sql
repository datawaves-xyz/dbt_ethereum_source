{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function superrare_superrare_ownershiptransferred_eventdecodeudf as "io.iftech.sparkudf.hive.Superrare_SuperRare_OwnershipTransferred_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
