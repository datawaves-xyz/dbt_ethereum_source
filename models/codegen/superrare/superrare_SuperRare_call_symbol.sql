{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function superrare_superrare_symbol_calldecodeudf as "io.iftech.sparkudf.hive.Superrare_SuperRare_symbol_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.5.jar";'
        }
    )
}}
