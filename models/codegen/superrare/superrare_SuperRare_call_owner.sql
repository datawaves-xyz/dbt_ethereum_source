{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function superrare_superrare_owner_calldecodeudf as "io.iftech.sparkudf.hive.Superrare_SuperRare_owner_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
