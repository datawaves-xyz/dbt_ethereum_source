{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_registrar0_finalizeauction_calldecodeudf as "io.iftech.sparkudf.hive.Ens_Registrar0_finalizeAuction_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
