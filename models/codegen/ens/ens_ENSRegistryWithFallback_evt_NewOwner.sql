{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ensregistrywithfallback_newowner_eventdecodeudf as "io.iftech.sparkudf.hive.Ens_ENSRegistryWithFallback_NewOwner_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
