{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_baseregistrarimplementation_transfer_eventdecodeudf as "io.iftech.sparkudf.hive.Ens_BaseRegistrarImplementation_Transfer_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
