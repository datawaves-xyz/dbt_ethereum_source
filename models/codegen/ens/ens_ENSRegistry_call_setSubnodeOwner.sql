{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ensregistry_setsubnodeowner_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ENSRegistry_setSubnodeOwner_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
