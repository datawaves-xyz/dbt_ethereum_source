{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_registrar0_hashreleased_eventdecodeudf as "io.iftech.sparkudf.hive.Ens_Registrar0_HashReleased_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
