{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_reverseregistrar1_defaultresolver_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ReverseRegistrar1_defaultResolver_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
