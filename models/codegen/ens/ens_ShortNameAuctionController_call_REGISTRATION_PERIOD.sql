{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_shortnameauctioncontroller_registration_period_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ShortNameAuctionController_REGISTRATION_PERIOD_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
