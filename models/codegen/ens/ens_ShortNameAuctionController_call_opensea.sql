{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_shortnameauctioncontroller_opensea_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ShortNameAuctionController_opensea_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
