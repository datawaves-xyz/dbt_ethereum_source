{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_baseregistrarimplementation_safetransferfrom_calldecodeudf as "io.iftech.sparkudf.hive.Ens_BaseRegistrarImplementation_safeTransferFrom_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
