{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ensregistry_newttl_eventdecodeudf as "io.iftech.sparkudf.hive.Ens_ENSRegistry_NewTTL_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
