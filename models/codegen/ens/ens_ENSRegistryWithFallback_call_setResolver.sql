{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ensregistrywithfallback_setresolver_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ENSRegistryWithFallback_setResolver_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
