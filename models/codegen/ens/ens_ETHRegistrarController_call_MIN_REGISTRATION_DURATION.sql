{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ethregistrarcontroller_min_registration_duration_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ETHRegistrarController_MIN_REGISTRATION_DURATION_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
