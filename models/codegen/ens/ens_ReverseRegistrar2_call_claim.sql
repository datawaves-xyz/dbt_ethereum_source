{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_reverseregistrar2_claim_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ReverseRegistrar2_claim_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
