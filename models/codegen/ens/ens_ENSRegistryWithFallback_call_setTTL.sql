{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ensregistrywithfallback_setttl_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ENSRegistryWithFallback_setTTL_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
