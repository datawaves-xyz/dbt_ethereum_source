{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_reverseregistrar2_addr_reverse_node_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ReverseRegistrar2_ADDR_REVERSE_NODE_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
