{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ethregistrarcontroller2_renew_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ETHRegistrarController2_renew_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
