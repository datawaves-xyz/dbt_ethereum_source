{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function ens_ethregistrarcontroller3_owner_calldecodeudf as "io.iftech.sparkudf.hive.Ens_ETHRegistrarController3_owner_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
