{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangev1_cancel_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV1_cancel_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.5.jar";'
        }
    )
}}
