{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangev2_upgraded_eventdecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV2_Upgraded_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.8.jar";'
        }
    )
}}
