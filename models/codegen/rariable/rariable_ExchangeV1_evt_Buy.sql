{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function rariable_exchangev1_buy_eventdecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV1_Buy_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
