{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangestatev1_owner_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeStateV1_owner_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
