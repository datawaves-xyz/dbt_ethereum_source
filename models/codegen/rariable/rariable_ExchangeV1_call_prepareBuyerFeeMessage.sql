{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangev1_preparebuyerfeemessage_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV1_prepareBuyerFeeMessage_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
