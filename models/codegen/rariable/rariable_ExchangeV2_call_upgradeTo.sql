{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangev2_upgradeto_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV2_upgradeTo_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
