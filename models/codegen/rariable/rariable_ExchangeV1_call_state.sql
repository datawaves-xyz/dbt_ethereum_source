{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangev1_state_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV1_state_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.6.jar";'
        }
    )
}}
