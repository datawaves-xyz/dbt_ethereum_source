{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function rariable_exchangestatev1_isoperator_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeStateV1_isOperator_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.10.jar";'
        }
    )
}}
