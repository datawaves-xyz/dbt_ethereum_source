{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function rariable_exchangev2_changeadmin_calldecodeudf as "io.iftech.sparkudf.hive.Rariable_ExchangeV2_changeAdmin_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
