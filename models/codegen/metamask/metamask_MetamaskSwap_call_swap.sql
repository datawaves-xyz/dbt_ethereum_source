{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function metamask_metamaskswap_swap_calldecodeudf as "io.iftech.sparkudf.hive.Metamask_MetamaskSwap_swap_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
