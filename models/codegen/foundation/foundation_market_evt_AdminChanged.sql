{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function foundation_market_adminchanged_eventdecodeudf as "io.iftech.sparkudf.hive.Foundation_market_AdminChanged_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.7.jar";'
        }
    )
}}
