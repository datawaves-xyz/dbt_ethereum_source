{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function foundation_market_upgraded_eventdecodeudf as "io.iftech.sparkudf.hive.Foundation_market_Upgraded_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
