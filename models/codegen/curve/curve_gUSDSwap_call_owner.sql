{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_owner_calldecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_owner_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.5.jar";'
        }
    )
}}
