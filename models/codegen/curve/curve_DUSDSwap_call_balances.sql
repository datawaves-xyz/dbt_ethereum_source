{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_balances_calldecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_balances_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
