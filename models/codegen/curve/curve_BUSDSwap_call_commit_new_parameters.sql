{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_busdswap_commit_new_parameters_calldecodeudf as "io.iftech.sparkudf.hive.Curve_BUSDSwap_commit_new_parameters_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.10.jar";'
        }
    )
}}
