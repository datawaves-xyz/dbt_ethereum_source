{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_linkusdswap_a_precise_calldecodeudf as "io.iftech.sparkudf.hive.Curve_LinkUSDSwap_A_precise_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.2.jar";'
        }
    )
}}
