{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_base_pool_calldecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_base_pool_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
