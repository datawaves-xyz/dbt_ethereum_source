{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_get_dy_underlying_calldecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_get_dy_underlying_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
