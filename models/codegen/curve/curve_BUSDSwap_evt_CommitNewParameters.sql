{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_busdswap_commitnewparameters_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_BUSDSwap_CommitNewParameters_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.6.jar";'
        }
    )
}}
