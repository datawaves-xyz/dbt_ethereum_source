{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_sethswap_commit_transfer_ownership_calldecodeudf as "io.iftech.sparkudf.hive.Curve_sETHSwap_commit_transfer_ownership_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.7.jar";'
        }
    )
}}
