{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_busdswap_removeliquidity_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_BUSDSwap_RemoveLiquidity_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.8.jar";'
        }
    )
}}
