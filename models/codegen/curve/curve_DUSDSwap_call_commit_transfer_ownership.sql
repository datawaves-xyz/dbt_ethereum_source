{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_commit_transfer_ownership_calldecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_commit_transfer_ownership_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.10.jar";'
        }
    )
}}
