{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_base_cache_updated_calldecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_base_cache_updated_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
