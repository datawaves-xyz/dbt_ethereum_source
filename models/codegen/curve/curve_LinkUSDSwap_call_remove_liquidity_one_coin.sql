{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_linkusdswap_remove_liquidity_one_coin_calldecodeudf as "io.iftech.sparkudf.hive.Curve_LinkUSDSwap_remove_liquidity_one_coin_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
