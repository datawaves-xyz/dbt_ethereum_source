{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_removeliquidity_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_RemoveLiquidity_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
