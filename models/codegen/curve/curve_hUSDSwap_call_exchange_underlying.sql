{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_husdswap_exchange_underlying_calldecodeudf as "io.iftech.sparkudf.hive.Curve_hUSDSwap_exchange_underlying_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
