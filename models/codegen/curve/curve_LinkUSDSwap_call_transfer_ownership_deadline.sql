{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_linkusdswap_transfer_ownership_deadline_calldecodeudf as "io.iftech.sparkudf.hive.Curve_LinkUSDSwap_transfer_ownership_deadline_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.1.jar";'
        }
    )
}}
