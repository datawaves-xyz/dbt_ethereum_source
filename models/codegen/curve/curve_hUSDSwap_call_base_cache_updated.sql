{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_husdswap_base_cache_updated_calldecodeudf as "io.iftech.sparkudf.hive.Curve_hUSDSwap_base_cache_updated_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.10.jar";'
        }
    )
}}
