{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_linkusdswap_fee_calldecodeudf as "io.iftech.sparkudf.hive.Curve_LinkUSDSwap_fee_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.2.jar";'
        }
    )
}}
