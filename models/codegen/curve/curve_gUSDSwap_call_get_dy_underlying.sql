{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_get_dy_underlying_calldecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_get_dy_underlying_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.3.jar";'
        }
    )
}}
