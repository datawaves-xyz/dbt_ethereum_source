{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_stoprampa_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_StopRampA_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
