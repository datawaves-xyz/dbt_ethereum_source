{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_busdswap_future_a_calldecodeudf as "io.iftech.sparkudf.hive.Curve_BUSDSwap_future_A_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
