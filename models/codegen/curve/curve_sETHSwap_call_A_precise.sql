{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_sethswap_a_precise_calldecodeudf as "io.iftech.sparkudf.hive.Curve_sETHSwap_A_precise_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
