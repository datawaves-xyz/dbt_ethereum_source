{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_sethswap_commitnewadmin_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_sETHSwap_CommitNewAdmin_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.14.jar";'
        }
    )
}}
