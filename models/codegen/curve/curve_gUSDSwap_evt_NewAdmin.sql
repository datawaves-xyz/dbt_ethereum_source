{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_newadmin_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_NewAdmin_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.3.jar";'
        }
    )
}}
