{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_sethswap_calc_withdraw_one_coin_calldecodeudf as "io.iftech.sparkudf.hive.Curve_sETHSwap_calc_withdraw_one_coin_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
