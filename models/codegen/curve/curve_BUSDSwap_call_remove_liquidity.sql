{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_busdswap_remove_liquidity_calldecodeudf as "io.iftech.sparkudf.hive.Curve_BUSDSwap_remove_liquidity_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.5.jar";'
        }
    )
}}
