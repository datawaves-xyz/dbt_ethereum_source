{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_husdswap_get_virtual_price_calldecodeudf as "io.iftech.sparkudf.hive.Curve_hUSDSwap_get_virtual_price_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.16.jar";'
        }
    )
}}
