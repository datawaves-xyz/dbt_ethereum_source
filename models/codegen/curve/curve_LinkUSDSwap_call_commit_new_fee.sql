{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_linkusdswap_commit_new_fee_calldecodeudf as "io.iftech.sparkudf.hive.Curve_LinkUSDSwap_commit_new_fee_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.6.jar";'
        }
    )
}}
