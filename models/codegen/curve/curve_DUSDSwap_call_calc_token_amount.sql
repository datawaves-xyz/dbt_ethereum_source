{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_dusdswap_calc_token_amount_calldecodeudf as "io.iftech.sparkudf.hive.Curve_DUSDSwap_calc_token_amount_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
