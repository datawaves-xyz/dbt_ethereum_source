{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_sethswap_initial_a_time_calldecodeudf as "io.iftech.sparkudf.hive.Curve_sETHSwap_initial_A_time_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.7.jar";'
        }
    )
}}
