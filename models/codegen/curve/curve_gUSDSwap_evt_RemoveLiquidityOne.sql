{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function curve_gusdswap_removeliquidityone_eventdecodeudf as "io.iftech.sparkudf.hive.Curve_gUSDSwap_RemoveLiquidityOne_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.6.jar";'
        }
    )
}}
