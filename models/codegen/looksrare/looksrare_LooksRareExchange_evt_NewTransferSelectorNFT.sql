{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function looksrare_looksrareexchange_newtransferselectornft_eventdecodeudf as "io.iftech.sparkudf.hive.Looksrare_LooksRareExchange_NewTransferSelectorNFT_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
