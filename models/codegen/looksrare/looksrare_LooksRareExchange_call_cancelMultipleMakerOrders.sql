{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function looksrare_looksrareexchange_cancelmultiplemakerorders_calldecodeudf as "io.iftech.sparkudf.hive.Looksrare_LooksRareExchange_cancelMultipleMakerOrders_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.9.jar";'
        }
    )
}}
