{{
    config(
        ...
        file_format='parquet',
        pre_hook={
            'sql': 'create or replace function looksrare_looksrareexchange_updatetransferselectornft_calldecodeudf as "io.iftech.sparkudf.hive.Looksrare_LooksRareExchange_updateTransferSelectorNFT_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf.jar";'
        }
    )
}}
