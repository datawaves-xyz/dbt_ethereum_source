{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function looksrare_looksrareexchange_newexecutionmanager_eventdecodeudf as "io.iftech.sparkudf.hive.Looksrare_LooksRareExchange_NewExecutionManager_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.4.jar";'
        }
    )
}}
