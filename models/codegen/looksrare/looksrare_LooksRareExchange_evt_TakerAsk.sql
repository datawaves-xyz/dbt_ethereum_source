{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function looksrare_looksrareexchange_takerask_eventdecodeudf as "io.iftech.sparkudf.hive.Looksrare_LooksRareExchange_TakerAsk_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
