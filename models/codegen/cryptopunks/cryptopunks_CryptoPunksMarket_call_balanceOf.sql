{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function cryptopunks_cryptopunksmarket_balanceof_calldecodeudf as "io.iftech.sparkudf.hive.Cryptopunks_CryptoPunksMarket_balanceOf_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.3.jar";'
        }
    )
}}
