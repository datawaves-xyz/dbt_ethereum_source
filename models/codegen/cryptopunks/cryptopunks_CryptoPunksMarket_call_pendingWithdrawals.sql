{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function cryptopunks_cryptopunksmarket_pendingwithdrawals_calldecodeudf as "io.iftech.sparkudf.hive.Cryptopunks_CryptoPunksMarket_pendingWithdrawals_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.5.jar";'
        }
    )
}}
...
with base as (
    ...
    and selector = "0xf3f43703"
    and selector_hash = abs(hash("0xf3f43703")) % 10
