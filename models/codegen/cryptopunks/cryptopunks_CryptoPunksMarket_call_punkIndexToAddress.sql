{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function cryptopunks_cryptopunksmarket_punkindextoaddress_calldecodeudf as "io.iftech.sparkudf.hive.Cryptopunks_CryptoPunksMarket_punkIndexToAddress_CallDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.15.jar";'
        }
    )
}}
