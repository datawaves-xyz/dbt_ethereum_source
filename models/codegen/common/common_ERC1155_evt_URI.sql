{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function common_erc1155_uri_eventdecodeudf as "io.iftech.sparkudf.hive.Common_ERC1155_URI_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.13.jar";'
        }
    )
}}
