{{
    config(
        ...
        pre_hook={
            'sql': 'create or replace function common_erc721_transfer_eventdecodeudf as "io.iftech.sparkudf.hive.Common_ERC721_Transfer_EventDecodeUDF" using jar "s3a://blockchain-dbt/dist/jars/blockchain-dbt-udf-0.1.7.jar";'
        }
    )
}}
